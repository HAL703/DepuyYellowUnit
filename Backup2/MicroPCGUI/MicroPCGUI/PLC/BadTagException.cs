...
namespace MicroPCGUI.PLC
{
    ...
    /// (due to controller timeout, unplugged controller, or power blackout),
    ...
    public class BadTagException : Exception
    {
        ...
        public BadTagException(Logix.Tag tagName, int tagType)
        {
            switch (tagType)
            {
                case 1: //case 1 is here for the many tags that are UDTs and are arrays like gui_general_struct[4], for example
